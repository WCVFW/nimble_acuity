...
<<<<<<< HEAD
        <h1 className="text-4xl font-bold mb-4">Outsource Image Analysis Services</h1>
=======
...
<<<<<<< HEAD
        <h2 className="text-3xl font-bold text-center mb-10">Why Outsource Image Analysis to O2I?</h2>
=======
...
<<<<<<< HEAD
              O2I delivered hundreds of KOL database services using proprietary methodologies, irrespective of geography.
=======
...
<<<<<<< HEAD
        <h2 className="text-3xl font-bold mb-4">Outsource Image Analysis Solutions to O2I</h2>
        <p className="max-w-2xl mx-auto mb-6">
          With 26+ years of experience and 18,000+ clients, we deliver accurate, error-free, and cost-effective image analysis solutions. Outsource to us and reap up to 40% cost benefits.
=======

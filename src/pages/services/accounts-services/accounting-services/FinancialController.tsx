  ...
  return (
    <div className="bg-white text-[#006A7C] p-10">
      ...
      <ul className="list-disc list-inside space-y-2 text-gray-700 mb-6">
        <li>
          <strong>Financial Statement Preparation:</strong> Prepare financial statements for audits, collaborating with auditors to reconcile credit lines, loans, and other financial records.
        </li>
        <li>
          <strong>Ledger Maintenance:</strong> Keep your business ledger updated with all transactions, accurately tracking earnings and expenditures.
        </li>
        <li>
          <strong>Financial Control Planning:</strong> Review processes, perform KPI reporting, and handle financial controlling activities for better business management.
        </li>
        <li>
          <strong>Cash Flow Analysis:</strong> Conduct fluctuation analysis and provide detailed reports for stakeholders.
        </li>
        <li>
          <strong>Budgeting and Forecasting:</strong> Offer strategic, forward-focused budgeting support and forecast financial performance.
        </li>
        <li>
          <strong>Fixed Asset Management:</strong> Track and secure company assets with serial numbers and barcodes.
        </li>
      </ul>
      ...
      <ol className="list-decimal list-inside space-y-2 text-gray-700 mb-6">
        <li>
          <strong>Preparation:</strong> Collect necessary financial statements and information from your business.
        </li>
        <li>
          <strong>Planning:</strong> Build a focused financial model and submit it for approval.
        </li>
        <li>
          <strong>Financial Control:</strong> Implement budgeting, ledger maintenance, fixed asset management, and other controlling activities.
        </li>
        <li>
          <strong>Reporting:</strong> Deliver exhaustive project reports and clear financial overviews.
        </li>
      </ol>
      ...
      <p className="mt-4 text-gray-700">
        If you are looking for a trustworthy financial controller service provider, contact our experts now.
      </p>
=======

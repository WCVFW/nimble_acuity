  ...
  return (
    <div className="bg-white text-[#006A7C] p-10">
      ...
      <p className="mb-4 text-gray-700">
        Manage seasonal demand hikes with our on-demand financial reporting services. We provide scalable solutions that optimize resource allocation, streamline ROI, and ensure client satisfaction.
      </p>
      <p className="mb-4 text-gray-700">
      ...
      {/* Process Flow */}
      <h2 className="text-2xl font-semibold mt-8 mb-4">
        Step-by-Step Financial Statement Solutions Process
      </h2>
      ...
      <p className="mt-4 text-gray-700">
        Contact Nimble Acuity today to scale your financial statement preparation efficiently, ensuring accuracy, compliance, and measurable value for your clients.
      </p>
=======

    ...
    <div className="bg-white text-gray-800">
      ...
      <section className="text-center py-16 px-6 bg-gradient-to-r from-indigo-600 to-purple-700 text-white">
        ...
        <p className="max-w-2xl mx-auto mb-6">
          Outsource2india provides high-quality photo compositing services with experienced editors using the latest tools and techniques to bring your vision to life.
        </p>

...
const OutsourceInsuranceServices: React.FC = () => {
  return (
    <div className="font-sans">
      ...
      <section className="bg-blue-50 py-16">
        <div className="max-w-5xl mx-auto px-4 text-center">
          <h1 className="text-4xl font-bold mb-4">
            Why Should You Outsource Insurance Services to a Professional Service Provider?
          </h1>
          <p className="text-lg text-gray-700">
            Insurance services are often outsourced to reduce workload and efficiently accomplish business requirements. Outsourcing helps companies handle high volumes of requests while enhancing operational outcomes.
          </p>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="max-w-5xl mx-auto px-4 space-y-4 text-gray-700">
          ...
          <p>
            By delegating operational tasks to a professional service provider, your company can focus on strategic priorities while the outsourced team handles insurance operations with precision.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-4 space-y-6">
          ...
          {[
            ...
            },
            {
              ...
              description:
                "Outsourced teams leverage established platforms and expertise, enabling faster execution of processes and boosting brand value."
            },
            {
      ...
      <section className="bg-blue-600 py-16 text-white text-center">
        <h2 className="text-3xl font-bold mb-4">
          Outsource Insurance Back-office Services to Outsource2india
        </h2>
        <p className="mb-6">
...
export default OutsourceInsuranceServices;
